...
На оценку "5" нужно реализовать требования для оценки "4", а также некоторые дополнительные возможности.
...
6. Отдельное окно (или область основного окна) на клиенте со списком всех файлов, имеющихся на сервере, и возможностью любой из них скачать.
